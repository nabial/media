                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="materi3"><button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Bentar, Aku mau baca halaman ini lagi</button></a>
                        
                        <a href="materi1"><button type="button" class="btn btn-outline"> Sudah, Aku mau tau tentang Routing Dinamis</button></a>
                      </div>
